...
export const metadata: Metadata = {
  ...
  description: 'DoorDash dashers on $40K net owe $5,652 SE tax + $3,200 federal in 2026. Mileage 72.5¢/mile saves $2,900+. Free calculator, all 51 states, no signup.',
  ...
  openGraph: {
    title: 'DoorDash Tax Calculator 2026 — $40K Net = $5,652 SE Tax',
    description: 'DoorDash dashers on $40K net owe $5,652 SE tax + federal in 2026. Mileage 72.5¢/mile saves $2,900+. Free calculator, all 51 states.',
  ...
  twitter: { card: 'summary_large_image', site: '@gigwisetax', creator: '@gigwisetax', title: 'DoorDash Tax Calculator 2026 — $40K Net = $5,652 SE Tax', description: 'Free DoorDash tax calculator. $40K net = $5,652 SE tax. All 51 states.' },
}
