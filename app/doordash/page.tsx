...
export async function generateStaticParams() { return [{ platform: 'doordash' }] }
...
export async function generateMetadata({ params }: { params: { platform: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: `DoorDash drivers: $40K net = $5,652 SE tax + federal. Mileage deduction up to 72.5¢/mile (2026 IRS rate) saves $2,900+. Free 2026 calculator, all 50 states + DC, no signup.`,
...
export default function PlatformPage({ params }: { params: { platform: string } }) {
  ...
  const deductionsSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Top Tax Deductions for DoorDash Workers 2026`,
    numberOfItems: 12,
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: "Mileage deduction" },
      { '@type': 'ListItem', position: 2, name: "Phone bill" },
      { '@type': 'ListItem', position: 3, name: "Auto insurance" },
      { '@type': 'ListItem', position: 4, name: "Insulated bags & delivery equipment" },
      { '@type': 'ListItem', position: 5, name: "Parking fees & tolls" },
      { '@type': 'ListItem', position: 6, name: "Accounting & tax software" },
      { '@type': 'ListItem', position: 7, name: "Self-employed health insurance premiums" },
      { '@type': 'ListItem', position: 8, name: "Phone mount, dash cam, car accessories" },
      { '@type': 'ListItem', position: 9, name: "Car washes & vehicle cleaning" },
      { '@type': 'ListItem', position: 10, name: "Half of self-employment tax" },
      { '@type': 'ListItem', position: 11, name: "Business bank account fees" },
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.gigwisetax.com"},{"@type":"ListItem","position":2,"name":"DoorDash Tax Calculator","item":"https://www.gigwisetax.com/doordash"}]}` }}/>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebPage","name":"DoorDash Tax Calculator 2026","url":"https://www.gigwisetax.com/doordash","dateModified":"2026-06-11","author":{"@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}` }}/>
      ...
      <div style={{ background: '#07111F', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 20px 48px', display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24 }} className="main-grid">
          ...
          <li dangerouslySetInnerHTML={{__html: 'IRS mileage rate is <strong>72.5¢/mile through June, 72.5¢/mile from July 2026</strong> — one of the largest deductions available to drivers'}}/>
...
<div style={{ background: '#07111F', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, overflow: 'hidden' as const, marginBottom: 16 }}>
          ...
          {/* OWN BANNER — privatepaycheck.com */}
            ...
            {/* STATES LINKS */}
            <PlatformStatesGrid platformSlug="doordash" />
