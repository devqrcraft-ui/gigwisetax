...
const PLATFORM_SLUG = 'grubhub'
const PLATFORM_NAME = 'Grubhub'
...
export default async function StatePage({ params }: { params: Promise<{ state: string }> }) {
  ...
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px', color: 'rgba(255,255,255,0.9)' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How are Grubhub drivers taxed?","acceptedAnswer":{"@type":"Answer","text":"Grubhub drivers are 1099 independent contractors. They pay self-employment tax (15.3%) plus income tax on net profit. Grubhub sends a 1099-NEC for earnings over $600."}},{"@type":"Question","name":"What can Grubhub drivers deduct?","acceptedAnswer":{"@type":"Answer","text":"Grubhub drivers can deduct mileage (72.5 cents/mile in 2026), insulated bags, phone bill, and other direct delivery expenses. Track every mile — it is the biggest deduction available."}},{"@type":"Question","name":"Does Grubhub withhold taxes?","acceptedAnswer":{"@type":"Answer","text":"No. Grubhub does not withhold taxes from driver earnings. Drivers are responsible for paying quarterly estimated taxes to avoid penalties."}},{"@type":"Question","name":"Does Grubhub take out taxes?","acceptedAnswer":{"@type":"Answer","text":"No. Grubhub pays drivers as independent contractors and does not withhold taxes. You must pay SE tax 15.3% yourself."}},{"@type":"Question","name":"How much should I set aside for Grubhub taxes?","acceptedAnswer":{"@type":"Answer","text":"Most Grubhub drivers should set aside 25-30% of net earnings."}},{"@type":"Question","name":"Will Grubhub send me a 1099?","acceptedAnswer":{"@type":"Answer","text":"Yes, if you earn $600 or more you receive a 1099-NEC."}}]}' }} />
