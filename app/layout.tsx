...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body style={{ margin:0, padding:0, boxSizing:'border-box', fontFamily:"'Segoe UI','Helvetica Neue',Arial,sans-serif", background:'#0d1117', overflowX:'clip', minHeight:'100vh' }}>
        ...
        <style>{`@media(max-width:900px){.desktop-nav{display:none!important}.desktop-cta{display:none!important}.mobile-hamburger{display:block!important}}`}</style>
            <Script src="/ai-chat-widget-v10.js" strategy="lazyOnload" />
    </body>
    </html>
  )
}
