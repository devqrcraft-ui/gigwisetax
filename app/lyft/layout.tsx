...
export const metadata: Metadata = {
  ...
  description: 'Calculate Lyft driver self-employment taxes. SE tax 15.3%, federal & state for all 50 states + DC. Mileage deduction, quarterly payment schedule. Free Lyft tax calculator 2026.',
  alternates: { canonical: 'https://www.gigwisetax.com/lyft' },
  openGraph: {
    title: 'Lyft Tax Calculator 2026 — Free, All 50 States + DC | GigWiseTax',
    description: 'Calculate Lyft driver self-employment taxes. SE tax 15.3%, federal & state for all 50 states + DC. Mileage deduction, quarterly payment schedule. Free Lyft tax calculator 2026.',
    siteName: 'GigWiseTax',
    type: 'website',
  },
