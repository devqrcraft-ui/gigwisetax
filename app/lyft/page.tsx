...
export default function PlatformPage({ params }: { params: { platform: string } }) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"Lyft Driver Tax Calculator 2026","url":"https://www.gigwisetax.com/lyft","dateModified":"2026-06-11","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}' }}/>
          ...
          {/* OWN BANNER — privatepaycheck.com */}
            ...
            <div style={{ background: '#07111F', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, overflow: 'hidden' as const }}>
              ...
              {[
                ...
                <a key={s.slug} href={`/${'lyft'}/${s.slug}`} style={{ textDecoration: 'none' }}>
