...
export default function QuarterlyReminder() {
  ...
  const inp  = { width: '100%', border: '2px solid #d1d5db', borderRadius: 6, padding: '13px 16px', fontSize: 16, fontWeight: 600, color: '#ffffff', background: '#07111F', boxSizing: 'border-box' as const, marginTop: 8 }
