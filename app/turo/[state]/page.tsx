...
const DEDUCTIONS = ["🔧 Vehicle maintenance","🛡️ Insurance premiums","🚗 Depreciation","🧹 Car cleaning & detailing","🅿️ Parking costs","💻 Turo platform fees","📱 Phone (business use)","🏠 Home office"]
  ...
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px', color: '#fff' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(255,255,255,.08)', borderRadius: 10, padding: 24, marginBottom: 32 }}>
        ...
        <GigCalculator platform={{ slug: PLATFORM_SLUG, name: PLATFORM_NAME, emoji: PLATFORM_EMOJI, naics: '492000', badge: null, searches: '' }} states={STATES} deadlines={[
          { quarter: 'Q1', due: 'April 15, 2026', period: 'Jan 1 – Mar 31' },
          { quarter: 'Q2', due: 'June 16, 2026', period: 'Apr 1 – May 31' },
          { quarter: 'Q3', due: 'September 15, 2026', period: 'Jun 1 – Aug 31' },
          { quarter: 'Q4', due: 'January 15, 2027', period: 'Sep 1 – Dec 31' },
        ]} />
      </div>
