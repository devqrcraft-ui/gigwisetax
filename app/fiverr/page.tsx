...
export const metadata: Metadata = {
  title: "Fiverr Tax Calculator 2026 ★ ✓ 100% Private",
  description: "Calculate your Fiverr taxes for 2026. ✓ Free ★ ✓ 100% Private ★ ✓ IRS 2026 Updated.",
  ...
  return (
    <div style={{ background: "#07111F", color: "#C8D8EC", minHeight: "100vh", padding: "60px 20px", fontFamily: "sans-serif" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        <h1 style={{ fontSize: "36px", fontWeight: 900, color: "#fff", marginBottom: "20px" }}>Fiverr Tax Calculator 2026 ★</h1>
        <div style={{ background: "rgba(232,184,75,0.06)", border: "1px solid rgba(232,184,75,0.2)", borderRadius: "12px", padding: "30px", marginBottom: "40px" }}>
          <p style={{ fontSize: "18px", lineHeight: 1.6, marginBottom: "24px" }}>Estimate your 2026 taxes for <strong>Fiverr</strong>. ✓ 100% Private.</p>
