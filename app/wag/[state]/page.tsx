...
export default async function StatePage({ params }: { params: Promise<{ state: string }> }) {
  ...
  const stateNote = state.name + (noStateTax ? ' has no state income tax. Wag walkers in ' + state.name + ' only pay federal income tax and the 15.3% self-employment tax.' : ' has a ' + stateRateStr + ' state income tax rate. Wag walkers in ' + state.name + ' must make both federal and state quarterly estimated tax payments.')
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do Wag walkers pay taxes?","acceptedAnswer":{"@type":"Answer","text":"Yes. Wag classifies walkers as independent contractors. Wag does not withhold taxes. If you earn $400 or more you must pay self-employment tax (15.3%) plus federal and state income tax."}},{"@type":"Question","name":"Does Wag send a 1099?","acceptedAnswer":{"@type":"Answer","text":"Wag payments are processed through Stripe Express, not Wag directly. Stripe sends a 1099 if you earn $600 or more in a calendar year. Even without a 1099 all income is taxable and must be reported on Schedule C."}},{"@type":"Question","name":"What can Wag walkers deduct?","acceptedAnswer":{"@type":"Answer","text":"Wag walkers can deduct mileage driving to client homes, pet supplies, a home office if used exclusively for the business, liability insurance, and payments to any sub-walkers (reported on a 1099-NEC if $600 or more)."}}]}' }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebApplication","name":"Wag Tax Calculator ' + state.name + ' 2026","applicationCategory":"FinanceApplication","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}' }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.gigwisetax.com"},{"@type":"ListItem","position":2,"name":"Wag Tax Calculator","item":"https://www.gigwisetax.com/wag"},{"@type":"ListItem","position":3,"name":"' + state.name + '","item":"https://www.gigwisetax.com/wag/' + state.slug + '"}]}' }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"Wag Tax Calculator ' + state.name + ' 2026","url":"https://www.gigwisetax.com/wag/' + state.slug + '","dateModified":"2026-07-25","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}' }} />
        ...
        <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#07111F)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '16px 16px 12px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,.55)', fontSize: 14, lineHeight: 1.8, paddingLeft: 16, maxWidth: 780, marginBottom: 18 }}>
              {'Free ' + platform.name + ' dog walker tax calculator for ' + state.name + ' (' + state.abbr + ').'}
        ...
        <div style={{ maxWidth:1200, margin:'0 auto', padding:'4px 16px 0' }}>
          ...
          <section id="key-takeaways" style={{ background:'rgba(232,184,75,0.06)', border:'1px solid rgba(232,184,75,0.2)', borderRadius:8, padding:'20px 24px', marginBottom:24 }}>
            ...
            <ul style={{ margin:0, padding:'0 0 0 18px', lineHeight:1.9, fontSize:14, color:'#C8D8EC' }}>
              <li>Wag walkers are independent contractors — Wag withholds zero taxes</li>
              <li>{'On $20,000 net income: ~$2,826 SE tax + ~$359 federal = ~$3,185 total in ' + state.name}</li>
              <li>{'Quarterly payments due Apr 15, Jun 16, Sep 15, Jan 15 — ~$796 each'}</li>
              <li>Wag pays through Stripe Express — your 1099 comes from Stripe, not Wag, at $600</li>
              <li>Pet care is an IRS-recognized tipped occupation (Code 506) — tips may qualify for the new 2026 tips deduction</li>
              <li>File Schedule C — report all Wag income even without a 1099 form</li>
            </ul>
          </section>
        </div>
          ...
          <div>
            ...
            <div style={card}>
              ...
              <div style={{ padding: 14 }}>
                ...
                <h3 style={{ fontSize: 17, fontWeight: 800, color: 'rgba(255,255,255,0.9)', marginBottom: 12 }}>Top Tax Deductions for {platform.name} Walkers in {state.name}</h3>
                ...
                {[
                  { q: 'Do Wag walkers pay taxes in ' + state.name + '?', a: noStateTax ? 'Yes. In ' + state.name + ', Wag walkers pay 15.3% self-employment tax plus federal income tax. There is no ' + state.name + ' state income tax.' : 'Yes. In ' + state.name + ', Wag walkers pay 15.3% SE tax, federal income tax (10-37%), plus ' + stateRateStr + ' ' + state.name + ' state income tax.' },
                  ...
                  { q: 'Does Wag take out taxes in ' + state.name + '?', a: 'No. Wag does not withhold taxes, and payments go through Stripe Express rather than Wag directly. You are responsible for paying all SE tax, federal income tax' + (noStateTax ? '' : ', and ' + state.name + ' state income tax') + ' yourself through quarterly estimated payments.' },
                ].map((item, i) => (
                ...
                <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 4, padding: 12, fontSize: 14, color: '#8fa8c8', lineHeight: 1.6 }}>
                  <strong>Disclaimer:</strong> State tax rates are for estimation purposes only. Not affiliated with Wag or any government agency. Consult a licensed CPA for advice.
                </div>
              </div>
            </div>
            <div style={card}>
