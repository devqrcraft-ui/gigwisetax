...
const schema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "OnlyFans workers can deduct mileage ($0.70/mile in 2026), phone and data plan, equipment, and 50% of self-employment tax. These deductions directly reduce taxable income and SE tax." }
    },
    {
      "@type": "Question",
