...
export const metadata: Metadata = {
  title: 'OnlyFans Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free OnlyFans tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               OnlyFans Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
          <p style={{ paddingLeft: 16, fontSize: 15, color: 'rgba(255,255,255,.75)', lineHeight: 1.6, maxWidth: 700, marginBottom: 16 }}>
            OnlyFans creators are self-employed. The platform issues a 1099-NEC for earnings over $600. You owe SE tax 15.3% on net profit plus income tax. Estimate your 2026 OnlyFans tax bill for all 50 states + DC.
          </p>
          {/* ANSWER-FIRST */}
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            OnlyFans creators earning <strong style={{color:'#e8b84b'}}>$40,000</strong> gross owe roughly <strong style={{color:'#e8b84b'}}>$8,852</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,213 per quarter</strong>. The platform's 20% fee is fully deductible, reducing your net profit and SE tax base.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>OnlyFans creators pay <strong>15.3% SE tax</strong> on net profit — the 20% platform fee comes off first</li>
            <li>At <strong>$40,000</strong> gross income, total tax is ~$8,852 — set aside $2,213 each quarter</li>
            <li>Top deductions: platform fee (20%), camera/lighting, props, editing software, home studio, internet</li>
            <li>OnlyFans sends a <strong>1099-NEC</strong> for earnings over $600 — report all income regardless</li>
