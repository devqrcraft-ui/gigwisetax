    ...
    <>
      ...
      <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#07111F)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 20px 28px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(22px,5vw,24px)', fontWeight: 900, color: '#fff', lineHeight: 1.2, margin: '0 0 14px' }}>Best Tax Software for Gig Workers 2026 — Ranked by Cost and 1099 Features</h1>
