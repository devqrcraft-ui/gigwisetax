  ...
  return (
    <div style={{ background: '#0d1117', minHeight: '100vh' }}>
      ...
      <div style={{ background:'rgba(232,184,75,0.06)', border:'1px solid rgba(232,184,75,0.2)', borderRadius:8, padding:'20px 24px', margin:'24px 0 16px' }}>
        <div style={{ fontSize:13, fontWeight:700, color:'#e8b84b', marginBottom:10, textTransform:'uppercase' as const, letterSpacing:'0.5px' }}>2026 Tax Summary — 1099 Deadlines 2025</div>
        <p style={{ fontSize:14, color:'rgba(255,255,255,0.85)', lineHeight:1.8, margin:0 }}>
          The 1099-NEC deadline is January 31, 2026 — both for sending to contractors and filing with the IRS. On $35,000 net gig income: approximately $4,950 SE tax + $2,800 federal = <strong style={{ color:'#fff' }}>$7,750 total tax</strong>. Quarterly estimated payment: <strong style={{ color:'#e8b84b' }}>$1,938</strong>. Missing deadlines triggers a $60–$630 penalty per form.
        </p>
      </div>
