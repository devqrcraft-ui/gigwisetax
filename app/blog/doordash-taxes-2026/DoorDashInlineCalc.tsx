...
export default function DoorDashInlineCalc() {
  ...
  return (
    <div style={{ background:'#0d1b2e', border:'2px solid #e8b84b', borderRadius:12, padding:24, margin:'32px 0', maxWidth:500 }}>
      ...
      <button onClick={calc} style={{ width:'100%', padding:14, background:'#e8b84b', color:'#07111F',
      ...
      {result && (
        <div style={{ borderTop:'1px solid #e8b84b33', paddingTop:20 }}>
          <div style={{ background:'#07111F', borderRadius:10, padding:16, marginBottom:14, textAlign:'center' }}>
            ...
            <div style={{ color:'#e8b84b', fontSize:36, fontWeight:900 }}>{fmt(result.quarterly)}</div>
