...
export const metadata: Metadata = {
  ...
  description: 'DoorDash taxes 2026: calculate SE tax (15.3%) + income tax in 60 seconds. Mileage deduction at $0.70/mile saves up to $3,400/yr. Quarterly dates included. Free.',
      ...
      <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#0d1b3e)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 20px 28px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,.55)', fontSize: 14, lineHeight: 1.8, textAlign: 'justify', maxWidth: 760, margin: 0 }}>
            Everything DoorDash drivers need to know about taxes in 2026. SE tax (15.3%), the new $0.70/mile mileage rate, quarterly payment deadlines, and every deduction Dashers can claim.
          </p>
        </div>
      </div>
          ...
          <div style={{ background: '#fff', border: '1px solid #d8dce6', borderRadius: 6, padding: 28, boxShadow: '0 1px 6px rgba(0,0,0,.05)' }}>
            ...
            <div style={{ background: '#fff5f5', border: '1px solid #fecaca', borderRadius: 6, padding: 16, marginBottom: 20 }}>
              ...
              <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: '#374151', lineHeight: 2 }}>
                ...
                <li><strong>2026 mileage rate: $0.70 per mile</strong></li>
            ...
            <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 6, padding: 16, marginBottom: 20 }}>
              <div style={{ fontWeight: 700, color: '#0369a1', marginBottom: 8, fontSize: 15 }}> 2026 Standard Mileage Rate: $0.70 per mile</div>
              <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.7, margin: '0 0 10px' }}>
                The IRS standard mileage rate for 2026 is <strong>$0.70 per mile</strong> driven for business.
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10 }}>
                {[
                  ...
                  <div key={r.miles} style={{ background: '#fff', border: '1px solid #bae6fd', borderRadius: 4, padding: 12, textAlign: 'center' as const }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 20 }} className="form-grid">
              {[
                { icon: '', name: 'Mileage ($0.70/mile)', detail: 'Most valuable deduction. Track every delivery mile from pickup to drop-off, plus en-route miles.' },
