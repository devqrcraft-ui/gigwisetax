...
export default function BlogPost() {
  return (
    <div style={{ background: "#0d1117", minHeight: "100vh" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do Lyft drivers file taxes in 2026?","acceptedAnswer":{"@type":"Answer","text":"Lyft drivers file taxes using Schedule C to report income and deductions. Use the 1099-K or 1099-NEC from Lyft plus your mileage log. Most drivers use tax software or a CPA for the first year."}},{"@type":"Question","name":"What is the Lyft mileage deduction for 2026?","acceptedAnswer":{"@type":"Answer","text":"Lyft drivers can deduct 67 cents per mile using the 2026 IRS standard mileage rate. This includes miles driven with passengers and while waiting for rides (deadhead miles may qualify if en route)."}},{"@type":"Question","name":"Does Lyft send tax forms to drivers?","acceptedAnswer":{"@type":"Answer","text":"Yes. Lyft sends a 1099-K if gross earnings exceed $600, or a 1099-NEC for referral bonuses. Forms are available in the Lyft driver app by January 31 each year."}}]}' }} />
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', color: '#fff' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 32 }}>
        ...
        <div style={{ background: 'rgba(255,255,255,.05)', borderRadius: 8, padding: '14px 16px', border: '1px solid rgba(255,255,255,.08)' }}>
          <div style={{ fontWeight: 700, marginBottom: 4 }}> Auto Insurance</div>
