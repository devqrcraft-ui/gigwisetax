...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What is the 2026 mileage rate for Uber drivers?', acceptedAnswer: { '@type': 'Answer', text: 'The 2026 IRS standard mileage rate is $0.70 per mile (70 cents). On 15,000 business miles, that is a $10,875 tax deduction — significantly reducing your taxable income.' } },
  ],
}
