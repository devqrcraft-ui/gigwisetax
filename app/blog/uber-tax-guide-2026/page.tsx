...
export const metadata: Metadata = {
  ...
  description: 'Complete Uber driver tax guide for 2026. SE tax 15.3%, mileage rate $0.70/mile, tip deduction up to $25,000, quarterly deadlines, and Schedule C filing. Free calculator included.',
...
const faqSchema = {
  ...
  mainEntity: [
    { '@type': 'Question', name: 'How much tax does an Uber driver pay in 2026?', acceptedAnswer: { '@type': 'Answer', text: 'Uber drivers pay 15.3% self-employment tax plus federal income tax. On $45,000 net income after mileage deductions, expect to owe approximately $14,000-$17,000. Set aside 25-30% of each payment. The mileage deduction at $0.70/mile significantly reduces taxable income.' } },
    ...
    { '@type': 'Question', name: 'What is the 2026 mileage rate for Uber drivers?', acceptedAnswer: { '@type': 'Answer', text: 'The 2026 IRS standard mileage rate is $0.70 per mile (72.5 cents). On 15,000 business miles, that is a $10,875 tax deduction — significantly reducing your taxable income.' } },
  ],
}
        ...
        <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#0d1b3e)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 20px 28px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,.55)', fontSize: 14, lineHeight: 1.8, textAlign: 'justify', maxWidth: 760, margin: 0 }}>
              Complete Uber driver tax guide for 2026. Includes the new $0.70/mile mileage rate, the new tips deduction (up to $25,000),
            ...
            <div style={{ background: '#fff', border: '1px solid #d8dce6', borderRadius: 6, padding: 28, boxShadow: '0 1px 6px rgba(0,0,0,.05)' }}>
              ...
              <div style={{ background: '#fff5f5', border: '1px solid #fecaca', borderRadius: 6, padding: 16, marginBottom: 20 }}>
                ...
                <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: '#374151', lineHeight: 2 }}>
                  ...
                  <li><strong>2026 mileage rate: $0.70/mile</strong> — highest in years</li>
              ...
              <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 6, padding: 16, marginBottom: 20 }}>
                <div style={{ fontWeight: 700, color: '#0369a1', marginBottom: 12 }}> $0.70 per mile in 2026</div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 20 }} className="form-grid">
                {[
                  { icon: '', name: 'Mileage ($0.70/mile)', detail: 'Largest deduction. Track every trip mile. Use standard OR actual expense method — not both.' },
                  ...
                  {[['Q1 2026','April 15, 2026','45',true],['Q2 2026','June 16, 2026','107',false],['Q3 2026','Sept 15, 2026','198',false],['Q4 2026','Jan 15, 2027','320',false]].map(([q,due,d,now],i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #f0f1f3', background: now ? '#fff9f9' : '#fff' }}>
                      ...
                      <td style={{ padding: '11px 14px' }}>
                        <span style={{ background: now ? '#fee2e2' : '#f0f4f8', color: now ? '#B22234' : '#374151', padding: '3px 10px', borderRadius: 12, fontSize: 12, fontWeight: 700 }}>{d} days</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
