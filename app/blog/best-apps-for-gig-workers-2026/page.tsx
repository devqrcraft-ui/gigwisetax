...
export default function BestAppsGigWorkers() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BlogPosting","headline":"Best Apps for Gig Workers 2026 — Track Miles, Taxes & Income","description":"Top 8 apps every gig worker needs in 2026.","url":"https://www.gigwisetax.com/blog/best-apps-for-gig-workers-2026","datePublished":"2026-05-14","dateModified":"2026-05-14","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"reviewedBy":{"@type":"Person","name":"Ethan Blake"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}' }} />
