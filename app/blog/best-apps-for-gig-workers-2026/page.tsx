...
export default function BestAppsGigWorkers() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BlogPosting","headline":"Best Apps for Gig Workers 2026 — Track Miles, Taxes & Income","description":"Top 8 apps every gig worker needs in 2026.","url":"https://gigwisetax.com/blog/best-apps-for-gig-workers-2026","datePublished":"2026-05-14","dateModified":"2026-05-14","author":{"@type":"Person","name":"Ethan Blake","jobTitle":"Tax Compliance Specialist","sameAs":["https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center"]},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://gigwisetax.com"}}' }} />
