      ...
      >
        <header>
          <nav aria-label="breadcrumb" style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', marginBottom: 20 }}>
            ...
            <span> › </span>Instacart Shopper Taxes 2026
          </nav>
          <h1
            itemProp="headline"
