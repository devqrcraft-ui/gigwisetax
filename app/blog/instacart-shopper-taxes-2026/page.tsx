...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'Yes. Instacart shoppers can deduct $0.725 per mile driven for business in 2026. This includes driving to the store, during shopping (parking lot counts), and delivering to customers. Track every mile using a mileage app. On 10,000 miles, this is a $7,250 deduction.' },
    },
  ],
}
              ...
              <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 6, padding: 16, marginBottom: 20 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10 }}>
                  {[
                    ...
                    { miles: '25,000', deduction: '$18,125', saves: '~$3,988' },
                  ].map(r => (
