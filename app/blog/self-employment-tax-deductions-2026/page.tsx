...
export default function DeductionsGuide() {
  const deductions = [
    { name: 'Standard Mileage Rate', amount: '$0.725 per mile', desc: 'Track every business mile. At 10,000 miles/year = $7,250 deduction. Use a mileage app or Google Maps logs.', tag: 'Most Popular' },
    ...
    { name: 'Education & Training', amount: '100% deductible', desc: 'Courses, books, YouTube Premium, subscriptions to improve your gig business skills. Must be related to current work.', tag: '' },
  ...
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', color: '#fff' }}>
      <nav style={{ fontSize: 13, color: 'rgba(255,255,255,.4)', marginBottom: 24 }}>
        <a href="/" style={{ color: 'rgba(255,255,255,.4)', textDecoration: 'none' }}>Home</a> › <a href="/blog" style={{ color: 'rgba(255,255,255,.4)', textDecoration: 'none' }}>Blog</a> › Deductions 2026
      </nav>
      ...
      <div style={{ background: 'linear-gradient(135deg,#1a1a3e,#0d1117)', borderRadius: 12, padding: '32px', marginBottom: 32, border: '1px solid rgba(165,180,252,.2)' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,.7)', lineHeight: 1.8, fontSize: 17 }}>
          The average gig worker overpays $2,000–$5,000 in taxes by missing deductions. This is the complete list for 2026 — every deduction available to 1099 workers, freelancers, and gig platform earners.
        </p>
      </div>
