...
export default function DeductionsGuide() {
  const deductions = [
    { name: 'Standard Mileage Rate', amount: '$0.67 per mile', desc: 'Track every business mile. At 10,000 miles/year = $6,700 deduction. Use a mileage app or Google Maps logs.', tag: 'Most Popular' },
