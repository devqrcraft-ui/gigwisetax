...
export default function DoorDashVsUberEatsPost() {
  ...
  return (
    <div style={{ background: '#07111F', minHeight: '100vh' }}>
      ...
      <script type='application/ld+json' dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BlogPosting","headline":"DoorDash vs Uber Eats Taxes 2026: Which Platform Pays More After Tax?","description":"Full 2026 tax comparison for DoorDash and Uber Eats drivers.","url":"https://gigwisetax.com/blog/doordash-vs-uber-eats-taxes-2026","datePublished":"2026-05-13","dateModified":"2026-05-13","author":{"@type":"Person","name":"Ethan Blake","jobTitle":"Tax Compliance Specialist","sameAs":["https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center"]},"reviewedBy":{"@type":"Person","name":"Ethan Blake","jobTitle":"Tax Compliance Specialist","sameAs":["https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center"]},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://gigwisetax.com"}}' }} />
