        ...
        <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 16 }}>
          ...
          <div style={{ background: '#07111F', border: '2px dashed #d8dce6', borderRadius: 6, overflow: 'hidden' as const }}>
            ...
            <div style={{ padding: 16 }}>
              <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: 4, height: 80, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 12 }}><span style={{ fontSize: 20, fontWeight: 800, color: '#7a9abf' }}>QB</span></div>
