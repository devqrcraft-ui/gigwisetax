...
export default function AmazonFlexTaxGuide() {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much tax does an Amazon Flex driver pay in 2026?","acceptedAnswer":{"@type":"Answer","text":"Amazon Flex drivers pay 15.3% self-employment tax plus federal income tax. On $40,000 net income after mileage deductions, expect to owe approximately $8,852 total — $5,652 SE tax + $3,200 federal. Set aside 25% of each payment. Quarterly estimated payment: $2,213."}},{"@type":"Question","name":"What is the 2026 mileage rate for Amazon Flex drivers?","acceptedAnswer":{"@type":"Answer","text":"The 2026 IRS standard mileage rate is 72.5 cents per mile ($0.725/mile). On 20,000 business miles, that is a $14,500 tax deduction — the single biggest deduction for Flex drivers."}},{"@type":"Question","name":"Does Amazon Flex send a 1099 form?","acceptedAnswer":{"@type":"Answer","text":"Yes. Amazon sends a 1099-NEC if you earned $600 or more during the year. You report this on Schedule C and deduct all business expenses including mileage, phone, and insulated bags."}},{"@type":"Question","name":"When are Amazon Flex quarterly taxes due in 2026?","acceptedAnswer":{"@type":"Answer","text":"Quarterly estimated taxes are due April 15, June 16, September 15, and January 15, 2027. Missing a payment triggers a penalty. On $40,000 net income, each quarterly payment is approximately $2,213."}},{"@type":"Question","name":"What can Amazon Flex drivers deduct in 2026?","acceptedAnswer":{"@type":"Answer","text":"Top deductions: mileage at 72.5c/mile, phone (business %), insulated delivery bags, car insurance (business %), and parking/tolls. The mileage deduction alone on 20,000 miles saves $3,263 in taxes."}}]}` }}/>
        ...
        <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#07111F)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 20px 28px' }}>
            <nav style={{ fontSize: 12, color: 'rgba(255,255,255,.4)', marginBottom: 14 }}>
              <a href="/" style={{ color: 'rgba(255,255,255,.4)', textDecoration: 'none' }}>Home</a> <span> › </span>
              <a href="/blog" style={{ color: 'rgba(255,255,255,.4)', textDecoration: 'none' }}>Blog</a> <span> › </span>
