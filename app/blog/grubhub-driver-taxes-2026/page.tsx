...
export default function BlogPost() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(16px,4vw,32px)', color: 'rgba(255,255,255,0.9)' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Grubhub Driver Taxes 2026 — Complete Tax Guide","description":"How to file Grubhub driver taxes in 2026. Mileage deduction, 1099-NEC, quarterly payments. Free calculator — no signup.","url":"https://www.gigwisetax.com/blog/grubhub-driver-taxes-2026","datePublished":"2026-01-01","dateModified":"2026-05-12","author":{"@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"},"reviewedBy":{"@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}` }} />
      ...
      <div style={{ background:'rgba(232,184,75,0.06)', border:'1px solid rgba(232,184,75,0.2)', borderRadius:8, padding:'20px 24px', margin:'24px 0 16px' }}>
        ...
        <p style={{ fontSize:14, color:'rgba(255,255,255,0.85)', lineHeight:1.8, margin:0 }}>
          Grubhub drivers pay 15.3% self-employment tax on net earnings. On $35,000 net income: approximately $4,950 SE tax + $2,800 federal income tax = <strong style={{ color:'#fff' }}>$7,750 total tax</strong>. Quarterly estimated payment: <strong style={{ color:'#e8b84b' }}>$1,938</strong>. Set aside 25% of every Grubhub payment. Mileage at 72.5¢/mile and insulated bags are key deductions.
        </p>
      </div>
        <p style={{ color: 'rgba(255,255,255,.7)', lineHeight: 1.8, fontSize: 17 }}>
          Grubhub classifies drivers as independent contractors. You receive a 1099-NEC and must pay self-employment tax (15.3%) plus federal and state income tax. Here is everything you need for 2026.
        </p>
      </div>
      ...
      <h2 style={{ fontSize: 24, fontWeight: 800, marginBottom: 16, borderBottom: '2px solid rgba(165,180,252,.2)', paddingBottom: 8 }}>
        Top Grubhub Tax Deductions 2026
      </h2>
