...
export const metadata: Metadata = {
  title: 'Lyft Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free Lyft tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               Lyft Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
          ...
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            Lyft drivers earning <strong style={{color:'#e8b84b'}}>$40,000</strong> owe roughly <strong style={{color:'#e8b84b'}}>$8,852</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,213 per quarter</strong>. SE tax is 15.3% on 92.35% of net profit. Mileage at 72.5¢/mile is your biggest deduction — log every trip.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>Lyft drivers pay <strong>15.3% SE tax</strong> on 92.35% of net profit — no employer splitting the cost</li>
            <li>At <strong>$40,000</strong> net income, total tax is ~$8,852 — set aside $2,213 each quarter</li>
            <li>Mileage at <strong>72.5¢/mile</strong> in 2026 covers all rideshare miles — deadhead miles included</li>
            <li>Lyft sends <strong>1099-NEC and 1099-K</strong> — report all earnings even without a form</li>
            <li>Quarterly deadlines: <strong>Apr 15 · Jun 16 · Sep 15 · Jan 15</strong> — miss one and face an IRS underpayment penalty</li>
          </ul>
        </div>
      </div>
