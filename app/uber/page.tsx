...
export async function generateMetadata({ params }: { params: { platform: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Uber drivers pay 15.3% SE tax + income tax. Calculate your exact 2026 tax bill in seconds — includes mileage deduction ($0.70/mile), quarterly dates. Free, all 50 states.`,
