...
export async function generateMetadata({ params }: { params: { platform: string } }): Promise<Metadata> {
  ...
  if (!p) return {}
  return {
    title: `Uber Tax Calculator 2026 — Free Driver Tax Estimator | GigWiseTax`,
    description: `Calculate your Uber driver taxes in 2026 — SE tax, federal & state income tax, quarterly payments. Free for all 51 states. No signup required.`,
...
export const metadata: Metadata = {
  title: 'Uber Driver Tax Calculator 2026 — SE Tax + All 51 States | GigWiseTax',
  description: 'Uber driver tax calculator 2026: estimate self-employment tax 15.3%, federal & state income tax. Mileage deduction $0.70/mile. Free, no signup.',
              ...
              <div style={{ padding: 24 }}>
                ...
                {isPlatformDriver && (
                  <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 6, padding: 16, marginBottom: 20 }}>
                    ...
                    <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.7, margin: 0 }}>
                      The 2026 standard mileage rate is <strong>${MILEAGE_RATE_2026} per mile</strong> (up from $0.70 in 2025).
                      Track every delivery mile using a mileage app. On 10,000 miles, that's a <strong>$7,250 deduction</strong> — reducing your taxable income significantly.
