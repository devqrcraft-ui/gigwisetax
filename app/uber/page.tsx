...
export default function PlatformPage({ params }: { params: { platform: string } }) {
  ...
  const deductionsSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: `Top Tax Deductions for Uber Workers 2026`,
    numberOfItems: 12,
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 9, name: "Half of self-employment tax" },
      { '@type': 'ListItem', position: 10, name: "Passenger amenities" },
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.gigwisetax.com"},{"@type":"ListItem","position":2,"name":"Uber Driver Tax Calculator 2026","item":"https://www.gigwisetax.com/uber"}]}` }}/>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebPage","name":"Uber Driver Tax Calculator 2026","url":"https://www.gigwisetax.com/uber","dateModified":"2026-06-11","author":{"@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}` }}/>
      ...
      <div style={{ background: '#07111F', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 20px 48px', display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24 }} className="main-grid">
          ...
          <li dangerouslySetInnerHTML={{__html: 'Set aside <strong>25–28%</strong> of gross Uber earnings each week to cover all tax obligations'}}/>
            </ul>
          </div>
          ...
          <div style={{ background:'rgba(232,184,75,0.06)', border:'1px solid rgba(232,184,75,0.2)', borderRadius:8, padding:'20px 24px', margin:'16px 0' }}>
            <div style={{ fontSize:13, fontWeight:700, color:'#e8b84b', marginBottom:10, textTransform:'uppercase' as const, letterSpacing:'0.5px' }}>2026 Tax Summary — Uber</div>
            <p style={{ fontSize:14, color:'rgba(255,255,255,0.85)', lineHeight:1.8, margin:0 }}>
              Uber workers pay 15.3% self-employment tax on net earnings, plus federal income tax. On $35,000 net income: approximately $4,950 SE tax + $2,800 federal income tax = <strong style={{ color:'#fff' }}>$7,750 total tax</strong>. Quarterly estimated payment: <strong style={{ color:'#e8b84b' }}>$1,938</strong>. Set aside 25% of every payment. Mileage deduction at 72.5¢/mile is the largest deduction for Uber drivers.
            </p>
          </div>
...
<div style={{ background: '#07111F', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, overflow: 'hidden' as const, marginBottom: 16 }}>
          ...
          {/* OWN BANNER — privatepaycheck.com */}
            ...
            {/* STATES LINKS */}
            <PlatformStatesGrid platformSlug="uber" />
...
{/* RELATED ARTICLES */}
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px 24px' }}>
        ...
        <ul style={{ paddingLeft: 20, lineHeight: 2, fontSize: 14 }}>
            ...
            <li><a href="/blog/uber-eats-tax-guide-2026" style={{ color: '#e8b84b', textDecoration: 'none' }}>Uber Eats Tax Guide 2026</a></li>
            <li><a href="/blog/doordash-vs-uber-eats-taxes-2026" style={{ color: '#e8b84b', textDecoration: 'none' }}>DoorDash vs Uber Eats: Tax Comparison 2026</a></li>
        </ul>
      </section>
      <AuthorBox />
      <style>{`
