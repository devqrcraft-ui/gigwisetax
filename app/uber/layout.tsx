...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Uber Driver Tax Calculator 2026 — $35K Net = $4,944 SE Tax',
    description: 'Uber drivers on $35K net owe $4,944 SE tax + federal in 2026. Mileage 72.5¢/mile deductible. Free calculator, all 50 states + DC.',
  ...
  twitter: { card: 'summary_large_image', site: '@gigwisetax', creator: '@gigwisetax', title: 'Uber Driver Tax Calculator 2026 — $35K Net = $4,944 SE Tax', description: 'Free Uber tax calculator. $35K net = $4,944 SE tax. All 50 States + DC.' },
}
