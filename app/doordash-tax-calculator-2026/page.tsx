...
export const metadata: Metadata = {
  title: 'DoorDash Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free DoorDash tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               DoorDash Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
          <p style={{ paddingLeft: 16, fontSize: 15, color: 'rgba(255,255,255,.75)', lineHeight: 1.6, maxWidth: 700, marginBottom: 16 }}>
            DoorDash drivers are independent contractors — you pay SE tax 15.3% on net earnings plus federal and state income tax. This calculator estimates your total 2026 tax bill and quarterly payments for all 50 states + DC.
          </p>
          {/* ANSWER-FIRST */}
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            DoorDash drivers earning <strong style={{color:'#e8b84b'}}>$40,000</strong> owe roughly <strong style={{color:'#e8b84b'}}>$8,852</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,213 per quarter</strong>. SE tax is 15.3% on 92.35% of net profit. Mileage at 72.5¢/mile is your biggest deduction.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>DoorDash drivers pay <strong>15.3% SE tax</strong> on 92.35% of net profit — no employer to split it</li>
            <li>At <strong>$40,000</strong> net income, total tax bill is ~$8,852 — set aside $2,213 each quarter</li>
            <li>IRS mileage deduction is <strong>72.5¢/mile</strong> in 2026 — tracking miles is the #1 way to cut your tax bill</li>
            <li>DoorDash sends a <strong>1099-NEC</strong> if you earn $600+ — but all income is taxable even without a form</li>
            <li>Quarterly deadlines: <strong>Apr 15 · Jun 16 · Sep 15 · Jan 15</strong> — miss one and face an IRS penalty</li>
          </ul>
        </div>
      </div>
