...
export const metadata: Metadata = {
  title: 'Uber Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free Uber tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
  alternates: { canonical: 'https://www.gigwisetax.com/uber-tax-calculator-2026' },
};
...
const schema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Uber workers can deduct mileage ($0.725/mile in 2026), phone and data plan, equipment, and 50% of self-employment tax. These deductions directly reduce taxable income and SE tax." }
    },
    {
      "@type": "Question",
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               Uber Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
          ...
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            Uber drivers earning <strong style={{color:'#e8b84b'}}>$50,000</strong> owe roughly <strong style={{color:'#e8b84b'}}>$11,565</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,891 per quarter</strong>. SE tax is 15.3% on 92.35% of net profit. Mileage at 72.5¢/mile is your biggest deduction — track every mile.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>Uber drivers pay <strong>15.3% SE tax</strong> on 92.35% of net profit — both employer and employee sides</li>
            <li>At <strong>$50,000</strong> net income, total tax is ~$11,565 — about $2,891 per quarter</li>
            <li>IRS mileage rate is <strong>72.5¢/mile</strong> in 2026 — tracking every trip mile cuts your bill significantly</li>
            <li>Uber sends both <strong>1099-NEC and 1099-K</strong> — report all income even if forms don't arrive</li>
            <li>Quarterly deadlines: <strong>Apr 15 · Jun 16 · Sep 15 · Jan 15</strong> — owe $1,000+ and you must pay quarterly</li>
          </ul>
        </div>
      </div>
      ...
      <div style={{ background: '#0d1117', padding: '48px 20px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column' as const, gap: 8 }}>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Mileage deduction — $0.725/mile for all rideshare trips</li>
