...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Amazon Flex Tax Calculator 2026 — $40K Net = $5,652 SE Tax',
    description: 'Amazon Flex drivers on $40K net owe $5,652 SE tax + federal in 2026. Mileage 72.5¢/mile saves $2,900+. Free calculator, all 50 states + DC.',
  ...
  twitter: { card: 'summary_large_image', site: '@gigwisetax', creator: '@gigwisetax', title: 'Amazon Flex Tax Calculator 2026 — $40K Net = $5,652 SE Tax', description: 'Free Amazon Flex tax calculator. $40K net = $5,652 SE tax. All 50 States + DC.' },
}
