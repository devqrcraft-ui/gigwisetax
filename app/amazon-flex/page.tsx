...
export async function generateMetadata({ params }: { params: { platform: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `Amazon Flex Tax Calculator 2026 — Free, Instant Results`,
...
export default function PlatformPage({ params }: { params: { platform: string } }) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.gigwisetax.com"},{"@type":"ListItem","position":2,"name":"Amazon Flex Tax Calculator 2026","item":"https://www.gigwisetax.com/amazon-flex"}]}` }}/>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebPage","name":"Amazon Flex Tax Calculator 2026","url":"https://www.gigwisetax.com/amazon-flex","dateModified":"2026-06-11","author":{"@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}` }}/>
...
<div style={{ background: '#07111F', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, overflow: 'hidden' as const, marginBottom: 16 }}>
          ...
          {/* OWN BANNER — privatepaycheck.com */}
            ...
            {/* STATES LINKS */}
            <PlatformStatesGrid platformSlug="amazon-flex" />
...
{/* RELATED ARTICLES */}
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px 24px' }}>
        ...
        <ul style={{ paddingLeft: 20, lineHeight: 2, fontSize: 14 }}>
            <li><a href="/blog/amazon-flex-taxes-2026" style={{ color: '#e8b84b', textDecoration: 'none' }}>Amazon Flex Taxes 2026: Complete Guide</a></li>
            <li><a href="/blog/amazon-flex-tax-guide-2026" style={{ color: '#e8b84b', textDecoration: 'none' }}>Amazon Flex Tax Guide 2026</a></li>
        </ul>
      </section>
      <AuthorBox />
      <style>{`
