...
export async function generateMetadata({ params }: { params: { platform: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Etsy sellers: $30K net = $4,594 SE tax + federal. Supplies, shipping, and home office deductions save $1,500+. Free 2026 calculator, all 50 states + DC.`,
...
export default function PlatformPage({ params }: { params: { platform: string } }) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"Etsy Seller Tax Calculator 2026","url":"https://www.gigwisetax.com/etsy","dateModified":"2026-06-11","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}' }}/>
          ...
          {/* OWN BANNER — privatepaycheck.com */}
            ...
            <div style={{ background: '#07111F', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, overflow: 'hidden' as const }}>
              ...
              {[
                ...
                <a key={s.slug} href={`/${'etsy'}/${s.slug}`} style={{ textDecoration: 'none' }}>
