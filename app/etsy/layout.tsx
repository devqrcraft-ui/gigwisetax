...
const gigSchema = {
  ...
  const schemaJsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebApplication",
        "name": "Etsy Tax Calculator 2026",
        "url": "https://www.gigwisetax.com/etsy",
        "description": "Free Etsy seller tax calculator 2026. SE tax + federal + state for all 51 states. No signup.",
        "applicationCategory": "FinanceApplication",
        "operatingSystem": "Any",
        "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Etsy Tax Calculator", "item": "https://www.gigwisetax.com/etsy" }
        ]
      }
    ]
  };
