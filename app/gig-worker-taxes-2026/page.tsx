...
const schema = {
  ...
  url: 'https://gigwisetax.com/gig-worker-taxes-2026',
  ...
  hasPart: [
    { '@type': 'WebApplication', name: 'DoorDash Tax Calculator', url: 'https://gigwisetax.com/doordash' },
    { '@type': 'WebApplication', name: 'Uber Tax Calculator', url: 'https://gigwisetax.com/uber' },
    { '@type': 'WebApplication', name: 'Etsy Tax Calculator', url: 'https://gigwisetax.com/etsy' },
    { '@type': 'WebApplication', name: 'OnlyFans Tax Calculator', url: 'https://gigwisetax.com/onlyfans' },
    { '@type': 'WebApplication', name: 'Instacart Tax Calculator', url: 'https://gigwisetax.com/instacart' },
    { '@type': 'WebApplication', name: 'Airbnb Tax Calculator', url: 'https://gigwisetax.com/airbnb' },
    { '@type': 'WebApplication', name: 'Amazon Flex Tax Calculator', url: 'https://gigwisetax.com/amazon-flex' },
    { '@type': 'WebApplication', name: 'Lyft Tax Calculator', url: 'https://gigwisetax.com/lyft' },
  ],
};
