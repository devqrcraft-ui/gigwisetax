    ...
    "@graph": [
      {
        ...
        "url": "https://www.gigwisetax.com/instacart",
        "description": "Free Instacart shopper tax calculator 2026. SE tax 15.3% + federal + state. All 51 states.",
        "applicationCategory": "FinanceApplication",
        "operatingSystem": "Any",
        "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Instacart Tax Calculator", "item": "https://www.gigwisetax.com/instacart" }
        ]
      }
    ]
  };
