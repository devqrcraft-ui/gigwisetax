                ...
                {[
                  {
                    ...
                    a: noStateTax
                      ...
                      : `In ${state.name}, ${platform.name} workers pay 15.3% self-employment tax, federal income tax (10–37%), plus ${stateRateStr} ${state.name} state income tax. On $35,000 net income, expect to owe approximately $${(7750 + Math.round(35000 * s.rate)).toLocaleString()} total.`,
                  },
                  {
