...
const schema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much tax does a Airbnb worker pay in 2026?",
      "acceptedAnswer": { "@type": "Answer", "text": "Airbnb workers pay 15.3% SE tax on 92.35% of net earnings plus federal income tax (10-22% for most earners) plus state income tax. A Airbnb worker earning $40,000 typically pays $10,000-$13,000 in total taxes depending on their state." }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Does Airbnb issue a 1099 form?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Airbnb issues a 1099-NEC for earnings over $600. You must report all income to the IRS even if you don't receive a 1099. Use IRS Schedule C to report profit and loss." }
    }
  ]
};
      ...
      <div style={{ background: 'linear-gradient(135deg,#1e2d5a,#0d1b3e)', borderBottom: '1px solid rgba(255,255,255,.07)', padding: '32px 20px 24px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            Airbnb hosts earning <strong style={{color:'#e8b84b'}}>$50,000</strong> owe roughly <strong style={{color:'#e8b84b'}}>$11,565</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,891 per quarter</strong>. Active hosts pay 15.3% SE tax on Schedule C. Passive rental income goes on Schedule E — no SE tax applies.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>Active Airbnb hosts pay <strong>15.3% SE tax</strong> on Schedule C — passive landlords use Schedule E (no SE tax)</li>
            <li>At <strong>$50,000</strong> net income, total tax is ~$11,565 — set aside $2,891 each quarter</li>
            <li>Top deductions: cleaning fees, host service fee (3%), depreciation, utilities, repairs, and furnishings</li>
            <li>Airbnb sends a <strong>1099-K</strong> if you earn $5,000+ — report all rental income regardless</li>
      ...
      <div style={{ background: '#0d1117', padding: '48px 20px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(18px,3vw,24px)', fontWeight: 900, color: '#fff', marginBottom: 8, marginLeft: 13 }}>
            Best Deductions for Airbnb Gig Workers
          </h2>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column' as const, gap: 8 }}>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Airbnb host service fee (3%)</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Cleaning fees and cleaning supplies</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Mortgage interest (proportional to rental use)</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Property depreciation (Schedule E)</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Utilities — electricity, internet, water</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Repairs and maintenance</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Furnishings and decor</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Property management fees</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Home insurance (rental portion)</li>
          </ul>
          <div style={{ marginTop: 24, padding: '16px 20px', background: 'rgba(184,146,74,0.08)', border: '1px solid rgba(184,146,74,0.25)', borderRadius: 8 }}>
            <div style={{ fontSize: 13, color: '#e8b84b', fontWeight: 700, marginBottom: 6 }}> Free Airbnb Deductions Checklist</div>
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6 }}>
              Get the full IRS Schedule C checklist for Airbnb workers — every deductible expense listed and explained.
            </div>
            <a href="https://1099deductions.com/airbnb" target="_blank" rel="noopener" style={{ display: 'inline-block', marginTop: 12, background: '#B8924A', color: '#07111F', fontSize: 13, fontWeight: 700, padding: '10px 20px', borderRadius: 6, textDecoration: 'none' }}>
              View Airbnb Deductions Checklist →
            </a>
          </div>
        </div>
      </div>
