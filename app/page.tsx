...
export default function Page() {
  return (
    <>
      <script type='application/ld+json' dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"SoftwareApplication","name":"GigWiseTax — 1099 Self-Employment Tax Calculator","url":"https://www.gigwisetax.com","description":"Free 1099 self-employment tax calculator. Calculates SE tax 15.3%, federal and state taxes for DoorDash, Uber, Instacart, OnlyFans and all gig workers. All 50 States + DC.","applicationCategory":"FinanceApplication","operatingSystem":"All","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}` }} />
      <script type='application/ld+json' dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much self-employment tax do gig workers pay in 2026?","acceptedAnswer":{"@type":"Answer","text":"Gig workers pay 15.3% self-employment (SE) tax on 92.35% of net earnings. You can deduct half of SE tax from your federal taxable income."}},{"@type":"Question","name":"Do I need to pay quarterly taxes as a gig worker?","acceptedAnswer":{"@type":"Answer","text":"Yes. If you expect to owe $1,000 or more, the IRS requires quarterly estimated payments. 2026 deadlines: April 15, June 16, September 15, January 15 2027."}},{"@type":"Question","name":"What is the 1099 threshold for gig work in 2026?","acceptedAnswer":{"@type":"Answer","text":"Platforms must issue a 1099-NEC if you earn $600 or more. You must report all income even without a 1099."}},{"@type":"Question","name":"How much should I set aside for taxes as a gig worker?","acceptedAnswer":{"@type":"Answer","text":"Set aside 25-30% of net gig income. Higher earners in CA or NY should set aside 35-40% to cover SE tax, federal, and state income tax."}}]}` }} />
      <HomeClient />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Organization","name":"the GigWiseTax Team","url":"https://www.gigwisetax.com"}` }} />
