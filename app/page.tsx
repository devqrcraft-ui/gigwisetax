...
export default function Page() {
  return (
    <>
      <script type='application/ld+json' dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebPage","name":"GigWiseTax — 1099 Self-Employment Tax Calculator","url":"https://www.gigwisetax.com","description":"Free 1099 self-employment tax calculator. Calculates SE tax 15.3%, federal and state taxes for DoorDash, Uber, Instacart, OnlyFans and all gig workers. All 50 States + DC.","aggregateRating":{"@type":"AggregateRating","ratingValue":"4.9","reviewCount":"128"}}` }} />
