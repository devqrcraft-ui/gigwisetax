      ...
      <div className="k99-wrap">
        ...
        <div className="diff-grid">
          ...
          <div className="diff-card k99c">
            ...
            <div className="diff-row"><span>Mileage deduction</span><span>$0.67/mile (2026)</span></div>
        ...
        <div className="deductions-box">
          ...
          <div className="ded-grid">
            <div className="ded-item"><span className="ded-check">✓</span><span>Mileage — $0.67/mile (IRS 2026 rate)</span></div>
        ...
        <div className="platforms-section">
          ...
          <div className="plat-grid">
            ...
            <Link href="/etsy" className="plat-card"><div className="plat-emoji">🛍️</div><div className="plat-name">Etsy</div><div className="plat-type">E-commerce</div></Link>
            ...
            <Link href="/self-employment-tax-calculator-2026" className="plat-card"><div className="plat-emoji">📊</div><div className="plat-name">SE Tax Guide</div><div className="plat-type">15.3% explained</div></Link>
          </div>
        </div>
        ...
        <div className="faq-section">
          ...
          <div className="faq-q"><div className="faq-qt">What deductions can 1099 gig workers claim?</div><div className="faq-qa">Mileage ($0.67/mile), phone plan, home office, equipment, platform fees, QBI deduction (up to 20% of net), and health insurance premiums for self-employed workers.</div></div>
        </div>
