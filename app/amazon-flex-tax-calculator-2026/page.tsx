...
export const metadata: Metadata = {
  title: 'Amazon Flex Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free Amazon Flex tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
  alternates: { canonical: 'https://www.gigwisetax.com/amazon-flex-tax-calculator-2026' },
};
...
const schema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much tax does a Amazon Flex worker pay in 2026?",
      "acceptedAnswer": { "@type": "Answer", "text": "Amazon Flex workers pay 15.3% SE tax on 92.35% of net earnings plus federal income tax (10-22% for most earners) plus state income tax. A Amazon Flex worker earning $40,000 typically pays $10,000-$13,000 in total taxes depending on their state." }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Does Amazon Flex issue a 1099 form?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Amazon Flex issues a 1099-NEC for earnings over $600. You must report all income to the IRS even if you don't receive a 1099. Use IRS Schedule C to report profit and loss." }
    }
  ]
};
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               Amazon Flex Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
          <p style={{ paddingLeft: 16, fontSize: 15, color: 'rgba(255,255,255,.75)', lineHeight: 1.6, maxWidth: 700, marginBottom: 16 }}>
            Amazon Flex drivers are independent contractors paid via 1099-NEC. SE tax 15.3% applies to net earnings. Estimate your 2026 Amazon Flex tax bill and quarterly IRS payment schedule.
          </p>
          {/* ANSWER-FIRST */}
          <div style={{background:'rgba(232,184,75,0.07)',border:'1px solid rgba(232,184,75,0.2)',borderRadius:8,padding:'14px 18px',marginBottom:12,marginLeft:16,fontSize:14,color:'rgba(255,255,255,0.85)',lineHeight:1.8}}>
            Amazon Flex drivers earning <strong style={{color:'#e8b84b'}}>$40,000</strong> owe roughly <strong style={{color:'#e8b84b'}}>$8,852</strong> in total taxes — about <strong style={{color:'#e8b84b'}}>$2,213 per quarter</strong>. SE tax is 15.3% on 92.35% of net profit. Mileage at 72.5¢/mile is your biggest deduction — log every delivery mile.
          </div>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'24px 20px 0'}}>
        <div style={{background:'rgba(232,184,75,0.08)',border:'1px solid rgba(232,184,75,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:8}}>
          ...
          <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
            <li>Amazon Flex drivers pay <strong>15.3% SE tax</strong> on 92.35% of net profit as independent contractors</li>
            <li>At <strong>$40,000</strong> net income, total tax is ~$8,852 — set aside $2,213 each quarter</li>
            <li>Mileage at <strong>72.5¢/mile</strong> in 2026 covers all delivery driving — from warehouse to drop-off</li>
            <li>Amazon Flex sends a <strong>1099-NEC</strong> for earnings over $600 — all income is taxable regardless</li>
      ...
      <div style={{ background: '#0d1117', padding: '48px 20px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(18px,3vw,24px)', fontWeight: 900, color: '#fff', marginBottom: 8, marginLeft: 13 }}>
            Best Deductions for Amazon Flex Gig Workers
          </h2>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column' as const, gap: 8 }}>
            ...
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Tolls and parking during deliveries</li>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Vehicle maintenance (if using actual expense method)</li>
          ...
          <div style={{ marginTop: 24, padding: '16px 20px', background: 'rgba(184,146,74,0.08)', border: '1px solid rgba(184,146,74,0.25)', borderRadius: 8 }}>
            <div style={{ fontSize: 13, color: '#e8b84b', fontWeight: 700, marginBottom: 6 }}> Free Amazon Flex Deductions Checklist</div>
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6 }}>
              Get the full IRS Schedule C checklist for Amazon Flex workers — every deductible expense listed and explained.
            </div>
            <a href="https://1099deductions.com/amazon-flex" target="_blank" rel="noopener" style={{ display: 'inline-block', marginTop: 12, background: '#B8924A', color: '#07111F', fontSize: 13, fontWeight: 700, padding: '10px 20px', borderRadius: 6, textDecoration: 'none' }}>
              View Amazon Flex Deductions Checklist →
            </a>
          </div>
        </div>
      </div>
