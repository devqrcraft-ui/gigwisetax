...
export const metadata: Metadata = {
  title: 'Amazon Flex Tax Calculator 2026 — SE Tax + All 51 States | GigWiseTax',
  description: 'Free Amazon Flex tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 51 states. Quarterly payment schedule included. No signup.',
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               Amazon Flex Tax Calculator 2026 — SE Tax + All 51 States
            </h1>
          </div>
