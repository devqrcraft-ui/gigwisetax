...
export const metadata: Metadata = {
  ...
  description: 'Airbnb hosts on $50K net owe $7,065 SE tax + federal in 2026. Depreciation + 14-day rule saves $3,000+. Free calculator, all 50 states + DC.',
  ...
  twitter: { card: 'summary_large_image', site: '@gigwisetax', creator: '@gigwisetax', title: 'Airbnb Tax Calculator 2026 — $50K Net = $7,065 SE Tax', description: 'Free Airbnb tax calculator. All 50 States + DC.' },
}
