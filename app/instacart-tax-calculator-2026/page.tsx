...
export const metadata: Metadata = {
  title: 'Instacart Tax Calculator 2026 — SE Tax + All 50 States + DC | GigWiseTax',
  description: 'Free Instacart tax calculator 2026. Estimate self-employment tax 15.3%, federal and state income tax for all 50 states + DC. Quarterly payment schedule included. No signup.',
...
const schema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Instacart workers can deduct mileage ($0.725/mile in 2026), phone and data plan, equipment, and 50% of self-employment tax. These deductions directly reduce taxable income and SE tax." }
    },
    {
      "@type": "Question",
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 12 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px,4vw,30px)', fontWeight: 900, color: '#fff', lineHeight: 1.25, margin: 0 }}>
               Instacart Tax Calculator 2026 — SE Tax + All 50 States + DC
            </h1>
          </div>
      ...
      <div style={{ background: '#0d1117', padding: '48px 20px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column' as const, gap: 8 }}>
            <li style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, paddingBottom: 4 }}>Mileage — $0.725/mile for driving to stores and delivering</li>
