...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Rover dog walkers: $25K net = $3,532 SE tax + federal. Mileage at 72.5¢/mile and supplies deductible. Free 2026 calculator, all 50 states + DC, no signup.`,
...
export default function PlatformPage() {
  ...
  return (
    <div>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.gigwisetax.com"},{"@type":"ListItem","position":2,"name":"Rover Sitter Tax Calculator 2026","item":"https://www.gigwisetax.com/rover"}]}' }}/>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"Rover Sitter Tax Calculator 2026","url":"https://www.gigwisetax.com/rover","dateModified":"2026-06-11","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"publisher":{"@type":"Organization","name":"GigWiseTax","url":"https://www.gigwisetax.com"}}' }}/>
      <GigCalculator platform={platform} states={STATES} deadlines={DEADLINES_2026}/>
          ...
          <div style={{ background:'rgba(232,184,75,0.06)', border:'1px solid rgba(232,184,75,0.2)', borderRadius:8, padding:'20px 24px', margin:'16px 0' }}>
            ...
            <p style={{ fontSize:14, color:'rgba(255,255,255,0.85)', lineHeight:1.8, margin:0 }}>
              Rover workers pay 15.3% self-employment tax on net earnings, plus federal income tax. On $25,000 net income: approximately $3,532 SE tax + $1,808 federal income tax = <strong style={{ color:'#fff' }}>$5,340 total tax</strong>. Quarterly estimated payment: <strong style={{ color:'#e8b84b' }}>$1,335</strong>. Set aside 25% of every payment. Phone, supplies, and home office deductions apply to Rover sitters.
            </p>
          </div>
    </div>
  )
