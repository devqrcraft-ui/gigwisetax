        ...
        <div style={{ background: '#fff', border: '1px solid #d8dce6', borderRadius: 6, marginBottom: 20, overflow: 'hidden' as const }}>
          ...
          <div style={{ padding: 20 }}>
            ...
            <p style={{ fontSize: 14, color: '#374151', lineHeight: 1.75, margin: 0 }}>
              You can deduct 50% of your SE tax from gross income, plus business expenses like mileage ($0.67/mile in 2026), phone, equipment, and home office. Most gig workers in {state.name} end up with an effective total tax rate of <strong>18%–28%</strong> after deductions.
            </p>
          </div>
        </div>
