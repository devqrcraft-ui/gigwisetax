...
const css = `
  ...
  @media(max-width:540px){#ai-win{width:calc(100vw - 8px);right:4px;bottom:0px;height:260px;border-radius:16px 16px 0 0;}.ai-msg{font-size:16px;}#ai-input{font-size:16px;}#ai-name{font-size:15px!important;}#ai-sub{font-size:13px!important;}}
`;
