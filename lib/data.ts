...
export const DEDUCTIONS = {
  doordash: [
    ...
    '🛡️ Auto insurance — business use percentage',
    '🧊 Insulated bags & delivery equipment',
    '🅿️ Parking fees & tolls',
  ...
  etsy: [
    ...
    '🖥️ Home office — $5/sq ft up to 300 sq ft',
  ...
  airbnb: [
    ...
    '🛋️ Furniture, linens & guest supplies',
    ...
    '🏛️ Property taxes — rental use percentage',
