...
export const DEDUCTIONS = {
  ...
  rover: [
    ...
    'Pet first aid kit',
    'Phone bill — Rover app business use percentage',
    'Home office deduction (if pet boarding at home)',
    'Self-employed health insurance premiums',
    'Half of self-employment tax (SE tax deduction)',
    'Accounting & tax software',
    'Business insurance & liability coverage',
  ...
  poshmark: [
    "Cost of goods sold — what you originally paid for resold items",
    "Poshmark selling fee (20% on sales $15+, $2.95 flat under $15)",
  ...
  taskrabbit: [
    ...
    'Phone bill — business use percentage',
    'TaskRabbit 15% service fee — business expense',
    'Parking fees & tolls',
  ...
  fiverr: [
    ...
    'Internet bill — business use percentage',
    'Home office deduction',
    'Computer, microphone, camera & equipment',
    'Fiverr 20% commission fee — business expense',
    'Stock assets, fonts & design resources',
    'Phone bill — business use percentage',
